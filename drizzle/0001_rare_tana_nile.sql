ALTER TABLE "techme_project_tasks" RENAME COLUMN "user_id" TO "created_by";--> statement-breakpoint
ALTER TABLE "techme_project_tasks" DROP CONSTRAINT "techme_project_tasks_user_id_techme_user_id_fk";
--> statement-breakpoint
ALTER TABLE "techme_project_tasks" ALTER COLUMN "created_by" SET NOT NULL;--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "techme_project_tasks" ADD CONSTRAINT "techme_project_tasks_created_by_techme_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."techme_user"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
